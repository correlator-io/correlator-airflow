# Contributing Guidelines for airflow-correlator

Thank you for considering contributing to airflow-correlator! This document provides guidelines to make the process as smooth as possible for everyone involved.
...
If you find a bug or issue with airflow-correlator, please open an issue in the project's [issue tracker](https://github.com/correlator-io/correlator-airflow/issues). Please provide as much detail as possible, including:

- Steps to reproduce the issue
- Expected behavior
- Actual behavior
- Python version and Airflow version
- Stack traces or error messages
- Airflow configuration (if applicable)

## Contributing Code

If you would like to contribute code to airflow-correlator, please follow these guidelines:
...
By contributing to airflow-correlator, you agree to license your contributions under the terms of the Apache License 2.0.
...
- `minor: Add support for Airflow 2.8+ task lifecycle events`
...
- Open an issue in this repository: https://github.com/correlator-io/correlator-airflow/issues
- Join the discussion: https://github.com/correlator-io/correlator/discussions

Thank you for contributing to airflow-correlator! 🎉
